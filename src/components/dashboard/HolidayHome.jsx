...
//   const handleImageUpload = async (type, index) => {
...
//         } else {
//           const newImages = [...(houseData.images || [])];
//           newImages[index] = newImageUrl;
//           setHouseData({ ...houseData, images: newImages });
//         }
...
//     const newAmenity = 'New Amenity'; // Keep it simple as a string
//     if (type === 'room') {
...
//   // Fixed amenity change handler
//   const handleAmenityItemChange = (type, amenityIndex, value) => {
//     if (type === 'room') {
//       setRoomData(prev => {
...
//   // Added missing general input handler
//   const handlePropertyInputChange = (type, field, value) => {
//     if (type === 'room') {
...
//   const PropertyCard = ({ data, type, isEditing, onEdit, onSave, onCancel, onImageUpload, onAddAmenity, onRemoveAmenity, onAmenityChange, onInputChange }) => {
